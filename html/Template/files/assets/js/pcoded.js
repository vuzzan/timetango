$.fn.pcodedmenu = function(settings) {
    ...
    var PcodedMenu = {
        ...
        HandleOffcanvasMenu: function() {
            //console.log( "HandleOffcanvasMenu");
            if (settings.themelayout === "vertical") {
                var vnt = $('#' + oid).attr("vertical-nav-type");
                if (vnt == "offcanvas") {
        ...
        HandleMenuOnClick: function() {
            ...
            if (settings.themelayout === "vertical") {
                ...
                $('#mobile-collapse,#mobile-collapse1,.sidebar_toggle a, .pcoded-overlay-box,.menu-toggle a').on("click", function() {
                    //console.log( "HandleMenuOnClick mobile-collapse");
                    $(this).parent().find('.menu-icon').toggleClass("is-clicked");
                    var dt = $('#' + oid).attr("pcoded-device-type");
                    //console.log( "HandleMenuOnClick mobile-collapse dt=" + dt);
                    if (dt == "desktop") {
                        ...
                        console.log( "HandleMenuOnClick mobile-collapse dmc=" + dmc + " dm=" + dm +" dn=" + dn);
                        console.trace()
                        if (dn == dm) {
